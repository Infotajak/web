...
(function(){injectScript([{"attr":[{"name":"id","value":"banner-container"},{"name":"style","value":"width:100%;margin:auto;text-

align:center;float:none;overflow:hidden;display:scroll;position:fixed;bottom:10px;z-index:999;-webkit-transform:translateZ(0);"}],"tag":"div","inner":"\n        <div style=\"margin-bottom: 

10px;\">\n<a onclick=\"document.getElementById(&quot;banner-container&quot;).style.display = &quot;none&quot;;\" style=\"cursor:pointer;\"><span style=\"vertical-align:middle; 

background: yellow; padding: 0px 11.3px 3px 11.3px; border: 3px solid red; color: red; font-size: 1em; font-weight: bold; border-radius: 100px;\"> close </span></a>\n</div>\n<div style=

\"text-align:center;display:block;max-width:300px;height:250px;overflow:hidden;margin:auto; border: 3px solid red; background: yellow;\">\n\n            <script type=\"text/javascript\">\n

\tatOptions = {\n\t\t'key' : 'adc1e9d02729faab00f9d20f138a3197',\n\t\t'format' : 'iframe',\n\t\t'height' : 250,\n\t\t'width' : 300,\n\t\t'params' : {}\n\t};\n</script>\n\n<iframe 

allowtransparency=\"true\" scrolling=\"no\" framespacing=\"0\" src=\"about:blank\" width=\"300\" height=\"250\" frameborder=\"0\"></iframe><script type=\"text/javascript\" src=

\"//outsetnormalwaited.com/adc1e9d02729faab00f9d20f138a3197/invoke.js\" class=\"atScriptcd1286b4f2d38e073d7453326f4b47e8_0\"></script>\n</div>\n"}],

{"target":"body"});function injectScript(e,t){let n=t.target;for(let t of e){let e=t.tag,r=t.inner,o=document.createElement(e);o.innerHTML=r;let c=t.attr;for(let e of c)o.setAttribute

(e.name,e.value);document.querySelector(n)&&document.querySelector(n).append(o)}}})();
